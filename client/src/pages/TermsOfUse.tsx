...
export default function TermsOfUse() {
  return (
    <div
      style={{
        padding: 50,
        backgroundColor: "rgb(71,98,87)",
      }}
    >
      <h1>Terms of use</h1>
      <p className="terms-header "> Welcome to our website. </p>
      <p className="terms-details">
        ...
        which together with our privacy policy govern our relationship with you
        in relation to this website. If you disagree with any part of these
        terms and conditions, please do not use our website. The term 'us' or
      ...
      <ul>
        ...
        <li>
          ...
          stored by us for use by third parties: name, email address, phone
          number, address, order history, preferences, etc.
        </li>
        <li>
        ...
        <li>
          ...
          the website is subject to the laws of Sweden.
        </li>
      </ul>
    </div>
  );
